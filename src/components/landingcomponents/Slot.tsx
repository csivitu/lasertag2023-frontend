    ...
    <>
      <main className="bg-black h-screen flex justify-center items-center">
       ...
       <div className="flex flex-col items-center justify-center gap-[2rem]">
          ...
          <div className={`${tektur.className} text-white text-center font-bold text-3xl`}>
            <span className="block ">You have a limited time to join the</span>
          ...
          <button className="flex justify-center text-slotBookHeadingFontSize w-full">
            <Image src="/landingassests/button.svg" alt="button" width={1} height={1} className="w-6/12" />
          </button>
        </div>
